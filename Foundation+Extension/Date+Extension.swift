...
extension Date {
    ...
    /// yyyy-MM-dd hh:mm
    static let formatterTillMinute: DateFormatter = {
    ...
    static let formatterForYear: DateFormatter = {
...
extension Date {
    ...
    static var thisYearBeginString: String {
        return Date().yearBeginDay.dateString()
    }
    
    static var thisYearEndString: String {
...
class DataTool: NSObject {
    @objc class func timeIntervalToString(timeInterval: TimeInterval) -> String {
        return Date.timeIntervalToString(timeInterval: timeInterval)
    }
    
    @objc class func timeIntervalToString(time: String) -> String {
