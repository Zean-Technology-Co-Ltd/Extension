...
extension String {
    ...
    func attribute(_ color: UIColor,
                   font: UIFont,
                   range: NSRange) -> NSMutableAttributedString {
    ...
    func attributeStrikethroughStyle(_ color: UIColor,
...
extension String {
    ...
    func textAutoSize(width: CGFloat, font: UIFont) -> CGSize {
        let string = self as NSString
        let rect = string.boundingRect(with:CGSize(width: width, height:0),
                                       options: [.usesLineFragmentOrigin, .usesFontLeading],
                                       attributes: [NSAttributedString.Key.font:font],
...
extension String{
    ///文件大小计算
    func transformFileSizeUnit() -> String {
...
/// 字符串数字改变Formatter
extension String {
    func changNumberFormatter(_ from: NumberFormatter, _ to: NumberFormatter) -> String? {
...
// 时间格式转换
extension String {
    func changDateFormatter(_ from: DateFormatter, _ to: DateFormatter) -> String? {
...
// 时间格式转换
extension String {
    func dateToTimeStamp(formatter : DateFormatter) -> Int{
