...
extension UIImage {
    ...
    static func userSexImage(_ sex: Int) -> UIImage {
        return sex == 2 ? girlImage : boyImage
    }
    
    static var girlImage: UIImage{
        return UIImage(named: "yf_home_user_recommend_girl")!
    }
    
    static var boyImage: UIImage{
        return UIImage(named: "yf_home_user_recommend_boy")!
    }
}
