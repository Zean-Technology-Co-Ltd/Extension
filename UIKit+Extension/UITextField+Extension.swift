...
extension UITextField {
    convenience init(attributedPlaceholder: String, color: UIColor, font: UIFont) {
        self.init()
    ...
    convenience init(placeholder: String, color: UIColor, font: UIFont) {
        self.init()
    ...
    convenience init(color: UIColor, font: UIFont, delegate: UITextFieldDelegate) {
        self.init()
        self.textColor = color
        self.font = font
    ...
    convenience init(text: String, color: UIColor, font: UIFont, delegate: UITextFieldDelegate) {
        self.init()
        self.text = text
        self.textColor = color
        self.font = font
    ...
    convenience init(placeholder: String, color: UIColor, font: UIFont, delegate: UITextFieldDelegate) {
        self.init()
        self.placeholder = placeholder
        self.textColor = color
        self.font = font
...
extension UITextField {
    ...
    public func dy_whenTapped(handler: @escaping () -> Void) {
        ...
        self.addTarget(self, action: #selector(UITextField.dy_touchUpInside), for: UIControl.Event.touchUpInside)
    }

    @objc
    func dy_touchUpInside() {
